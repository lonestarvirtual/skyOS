...
Rails.application.configure do
  ...
  # either ENV["RAILS_MASTER_KEY"] or in config/master.key. This key
  # is used to decrypt credentials (and other encrypted files).
  #
  # NOTE: Since we are targeting this as an open-source application for
  # anyone that may wish to use it, we are consciously avoiding using the
  # credential store to avoid installation complications for other users.
  #
